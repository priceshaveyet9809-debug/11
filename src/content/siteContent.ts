...
import { 
    Menu, X, ArrowRight, Play, Instagram, Youtube, Linkedin, Facebook, 
    CheckCircle, Trophy, Users, MonitorPlay, Calendar, MessageCircle, 
    Sparkles, Target, Globe, Award 
} from 'lucide-react';
...
export const siteContent = {
    ...
    showcase: {
        ...
        longVideos: [
            ...
            { thumb: "https://img.youtube.com/vi/cu17V4nZK-c/maxresdefault.jpg", videoId: "cu17V4nZK-c" },
        ...
        shortVideos: [
            ...
            { thumb: "https://images.unsplash.com/photo-1480074568708-e7b720bb3f09?auto=format&fit=crop&w=400&h=711&q=80", videoId: "cu17V4nZK-c" },
    ...
    about: {
        ...
        storyP2: "We combined Hollywood-grade cinematography with Silicon Valley data analytics to create a media agency that doesn't just show homes—it sells a lifestyle. Today, we partner with the most prestigious agencies in New York, Los Angeles, and Miami.",
        cta: "Meet the Team",
