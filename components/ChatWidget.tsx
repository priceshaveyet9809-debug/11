...
const ChatWidget: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{ role: 'user' | 'bot'; text: string }[]>([
    { role: 'bot', text: 'Welcome to PREES. I am your Luxury Media Assistant. How can I help you elevate your next listing?' }
  ]);
        ...
        <div className="bg-white w-80 sm:w-96 rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col animate-in slide-in-from-bottom-4 duration-500">
          <div className="bg-slate-900 p-5 flex justify-between items-center">
            <div className="flex items-center gap-3 text-white">
              ...
              <span className="font-black text-sm uppercase tracking-widest">PREES AI Assistant</span>
            </div>
